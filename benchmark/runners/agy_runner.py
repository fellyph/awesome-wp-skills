"""Runner implementation for Google Antigravity (agy) CLI."""
...
from benchmark.config import AGY_BIN, SKILLS_DIR
from benchmark.runners.base import BaseRunner


class AgyRunner(BaseRunner):
    """Executes benchmarks using Google Antigravity (agy)."""

    def __init__(
        self,
        executable_path: str = AGY_BIN,
    ...
    def mount_skill(self, workspace_dir: Path, skill_name: str) -> None:
        """Mount skill into .agents/skills/<skill_name>."""
